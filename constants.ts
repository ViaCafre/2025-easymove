...
export const INITIAL_ORDERS: ServiceOrder[] = [
  {
    ...
    notes: [
      { id: 'n1', content: 'Cliente VIP. Cuidado extremo com o piano de cauda.', color: '#10b981', createdAt: new Date().toISOString() }
    ],
  ...
  },
  {
    ...
    notes: [
       { id: 'n2', content: 'Aguardando confirmação de pagamento da coleta.', color: '#f59e0b', createdAt: new Date().toISOString() }
    ],
    createdAt: new Date().toISOString()
  },
  {
    ...
    notes: [
       { id: 'n3', content: 'Mudança corporativa.', color: '#3b82f6', createdAt: new Date().toISOString() },
       { id: 'n4', content: 'Nota fiscal antecipada solicitada pelo financeiro deles.', color: '#ef4444', createdAt: new Date().toISOString() }
    ],
    createdAt: new Date().toISOString()
  }
];
